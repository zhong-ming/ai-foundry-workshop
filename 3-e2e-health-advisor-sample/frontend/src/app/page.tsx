                  ...
                  drugCandidates.slice(0, 3).map((candidate) => (
                    <div key={candidate.id} className={cn("p-4 rounded-lg bg-background/50", hoverCardStyles)}>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <Tooltip content="AI-predicted effectiveness of the drug candidate">
                        ...
                        <div>
                          <Tooltip content="AI-predicted safety profile score">
                            <div className="flex items-center gap-1 cursor-help">
              ...
              <div className="space-y-4">
                {loading ? (
                  ...
                  <div key={trial.trial_id} className={cn("p-4 rounded-lg bg-background/50", hoverCardStyles)}>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <Tooltip content="Current enrollment progress vs target">
                          <div className="flex items-center gap-1 cursor-help">
                      ...
                      <div>
                        <Tooltip content="Number of detected safety concerns">
                          <div className="flex items-center gap-1 cursor-help">
